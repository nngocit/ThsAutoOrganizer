...
- [x] **Step 1: Viết bộ Design Tokens Google AI Studio Dark và Light**
Cập nhật `:root`, `[data-theme="dark"]`, và `[data-theme="light"]` với các mã màu chuẩn xác từ spec.

- [x] **Step 2: Định nghĩa cấu trúc CSS Grid 3 cột và topbar**
...
- [x] **Step 3: Kiểm tra cú pháp CSS bằng build script**
...
- [x] **Step 1: Cập nhật Cards, Badges và Buttons theo chuẩn AI Studio**
Chuyển đổi card viền mảnh `#3c4043`, góc bo `var(--r-md)`, nút bấm chính Google Blue `#1a73e8`, badge bo tròn pill-style.

- [x] **Step 2: Cập nhật kiểu dáng Bong bóng Chat & Ngăn kéo Trích dẫn NotebookLM**
...
- [x] **Step 3: Định nghĩa style cho Panel Nguồn và Studio Panel**
...
- [x] **Step 1: Cập nhật Topbar với logo Studio, Tab Bar và Nút Chuyển Theme**
Thay thế thanh topbar cũ bằng `.studio-topbar`, tích hợp nút `#theme-toggle-btn` (☀️/🌙).

- [x] **Step 2: Tạo cấu trúc 3 cột trong `.studio-body`**
...
- [x] **Step 1: Viết hàm quản lý Theme Dark / Light**
...
- [x] **Step 2: Viết hàm đóng / mở Cột 3 (Studio Panel Drawer)**
Gắn sự kiện click cho `#btn-toggle-studio-panel` để toggle class `.collapsed` trên `#panel-studio`.

- [x] **Step 3: Viết hàm nạp danh sách Môn học & Nguồn vào Cột Trái**
...
- [x] **Step 1: Kết nối checkbox nguồn ở Cột Trái với Chat AI**
...
- [x] **Step 2: Kết nối các nút Quick Action ở Cột Phải**
